...
#         logger.debug(
#             "logger.log start event_type=%s status=%s payload_keys=%d",
#             event_type,
#             status,
#             len((payload or {}).keys()),
#         )
...
#         logger.debug("logger.log ok size=%d", len(self._events))
#         return event

#     def recent(self, limit: int = 50) -> list[EventLog]:
#         logger.debug("logger.recent start limit=%d", limit)
#         if limit <= 0:
#             return []
#         result = list(self._events)[-limit:]
#         logger.debug("logger.recent ok returned=%d", len(result))
#         return result

#     def iter_all(self) -> Iterable[EventLog]:
#         logger.debug("logger.iter_all start")
#         return iter(self._events)

#     def size(self) -> int:
#         size = len(self._events)
#         logger.debug("logger.size ok size=%d", size)
#         return size
